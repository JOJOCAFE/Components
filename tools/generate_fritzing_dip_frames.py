...
def frame_svg(record: dict) -> str:
    ...
    lines = [
        ...
        f'  <desc id="desc">{esc(part)} DIP pin frame. Frame style adapted from {esc(EXTERNAL_SOURCE)} under {EXTERNAL_LICENSE}; local Components definition provides all pin truth.</desc>',
