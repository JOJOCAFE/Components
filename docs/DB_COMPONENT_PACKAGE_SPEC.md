...
All active IC packages under `lib/standard/74xx/` and `lib/standard/memory/` now use this package
...
`lib/standard/74xx/74HC245/` is the first reference package because it exercises:
