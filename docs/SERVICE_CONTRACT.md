...
```json
{
  ...
  "part": "74HC00",
  "group": "74xx",
  "db_path": "lib/standard/74xx/74HC00/definition/definition.json",
  "pins": [
...
```sh
python3 -m chiplib.cli circuit-faults examples/circuits/RV8GR_WholeSystemChipLevelVirtual/circuit.json
```
...
- The canonical chip identity DB is `lib/standard/` and is read through Components DB
  APIs.
