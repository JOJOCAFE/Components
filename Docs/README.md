...
- [`CIRCUIT_RUNNER_TASK_PLAN.md`](../Lib/Circuits/CIRCUIT_RUNNER_TASK_PLAN.md) -
  staged implementation checklist and current status.
- [`CIRCUIT_RUNNER_VERIFICATION_PLAN.md`](../Lib/Circuits/CIRCUIT_RUNNER_VERIFICATION_PLAN.md)
...
- [`RV8GR_CIRCUIT_TEST_CAMPAIGN.md`](../Lib/Circuits/RV8GR_CIRCUIT_TEST_CAMPAIGN.md)
  - generated readable summary of logical, part-model, composed/static,
  modeled-timing, and physical-evidence status.
- [`RV8GR_CIRCUIT_TEST_CAMPAIGN.json`](../Lib/Circuits/RV8GR_CIRCUIT_TEST_CAMPAIGN.json)
