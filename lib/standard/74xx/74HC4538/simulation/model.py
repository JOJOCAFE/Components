"""Local behavior model for 74HC4538."""
...
class HC4538(Chip):
    ...
    def __init__(self, name: str = "U"):
        pins = {1: ("1Cx", "passive"), 2: ("1RxCx", "passive"), 3: ("/1R", "in"), 4: ("1A", "in"), 5: ("1B", "in"), 6: ("1Q", "out"), 7: ("/1Q", "out"), 8: ("GND", "power"), 9: ("/2Q", "out"), 10: ("2Q", "out"), 11: ("2B", "in"), 12: ("2A", "in"), 13: ("/2R", "in"), 14: ("2RxCx", "passive"), 15: ("2Cx", "passive"), 16: ("VCC", "power")}
