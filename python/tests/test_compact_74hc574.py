"""Lossless clocked tri-state timing proof for the non-active 74HC574 pilot."""
...
class Compact74HC574Tests(unittest.TestCase):
    def test_clocked_tri_state_pilot_is_lossless_for_the_live_contract(self) -> None:
        base = ROOT / "lib" / "standard" / "74xx" / "74HC574"
