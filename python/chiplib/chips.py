...
class HC688(Chip):
    ...
    def __init__(self, name: str):
        pins = {1: ("/OE", "in"), 2: ("P0", "in"), 3: ("Q0", "in"), 4: ("P1", "in"),
                ...
                9: ("Q3", "in"), 10: ("GND", "power"), 11: ("/P=Q", "out"), 12: ("Q7", "in"),
                13: ("P7", "in"), 14: ("Q6", "in"), 15: ("P6", "in"), 16: ("Q5", "in"),
                17: ("P5", "in"), 18: ("Q4", "in"), 19: ("P4", "in"), 20: ("VCC", "power")}
    ...
    def update(self) -> None:
        if bit(self.read(1)):
            self.output(11, 1)
            return
        p = byte_from_pins(self, [2, 4, 6, 8, 19, 17, 15, 13])
        q = byte_from_pins(self, [3, 5, 7, 9, 18, 16, 14, 12])
        self.output(11, 0 if p == q else 1)
